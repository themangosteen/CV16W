...
% pathImgsTraining ... path to directory of training images (grayscale JPG) used 
...
% pathImgsTest     ... path to directory of images (grayscale JPG) to classify, based on 
...
disp(sprintf('\nCLASSIFY TEST IMAGES AND COMPARE CLASSIFICATIONS TO THEIR GROUND TRUTH'));
